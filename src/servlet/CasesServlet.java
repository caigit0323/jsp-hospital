...
public class CasesServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "insert into cases(pathographyid,history,allergy,symptom,analyzes,userid) values('"+pathographyid+"','"+history+"','"+allergy+"','"+symptom+"','"+analyze+"','"+userlogin.get(0)+"')";
