...
<table width="1870" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="1870" align="center" valign="top" class="border_left border_right border_bottom"><table width="50%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="5"></td>
        </tr>
      </table>
      <form action="RegisterServlet" method="post" name="form2">
        ...
        <table width="50%" border="0" cellspacing="0" cellpadding="0" class="border">
          ...
          <tr>
            <td height="25" colspan="2" align="center" class="tabletd2">病历号：<%=pathographyid %></td>
          </tr>
          <tr>
