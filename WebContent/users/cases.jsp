...
if(userlogin.get(3) != null && !userlogin.get(3).equals("医护")){
...
<table width="1870" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="400" align="center" valign="top" class="border_left border_right border_bottom"><table width="1870" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="5"></td>
        </tr>
      </table>
      <form action="CasesServlet?pathographyid=<%=pathographyid %>" method="post" name="form2" onSubmit="return reg()">
        ...
        for(i = 0;i < cases.size();i++){
         ...
         %>
        <table width="1870" border="0" cellspacing="0" cellpadding="0" class="border">
          <tr>
        ...
        <table width="1870" border="0" cellspacing="0" cellpadding="0" class="border">
		  ...
		  <tr>
		    ...
		    <td height="25" class="tabletd2"><table width="1870" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="1870" border="0" cellspacing="0" cellpadding="0">
                <%
