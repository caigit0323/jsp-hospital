...
if(userlogin.get(3) != null && !userlogin.get(3).equals("挂号人员")){
    ...
    <td height="400" align="center" valign="top" class="border_left border_right border_bottom"><table width="50%" border="0" cellspacing="0" cellpadding="0">
      ...
      <form action="RegisterServlet" method="post" name="form2" onSubmit="return reg()">
        <table width="1870" border="0" cellspacing="0" cellpadding="0" class="border">
          ...
          <tr>
            <td height="25" colspan="2" align="center" class="tabletd2">病历号：<%=Integer.parseInt(array.getMax().get(0).toString())+1 %></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="25" class="tabletd1">&nbsp;<input name="price" type="text" size="37"  readonly="readonly">&nbsp;元</td>
            <%-- //value="<%=array.getRegisterPrice("普通").get(2)%>" --%>
          </tr>
          <tr>
