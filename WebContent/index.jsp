  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <table width="50%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th height="70" colspan="2" class="ld" scope="col">医院病历管理系统</th>
		  </tr>
          <tr>
          ...
          <tr>
            <th height="35" colspan="2" scope="row" class="ln"><input class="submit" type="submit" value="登录"><input class="submit" onclick="location.href='zhuce.jsp'" type="button" value="注册"></th>
</tr>
        </table>
      </form>
      </td>
