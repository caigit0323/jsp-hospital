...
{	
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <form action="UserzhuServlet" method="post" name="form1" onSubmit="return login()">
      <table width="50%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th height="70" colspan="2" class="ld" scope="col">医院病历注册系统</th>
		  </tr>
          <tr>
          ...
          <tr>
            <th height="35" colspan="2" scope="row" class="ln"><input class="submit" type="submit" value="保存"><input class="submit" type="button" onclick="location.href='index.jsp'" value="有账号?点击登录"></th>
</tr>
        </table>
      </form>
      </td>
