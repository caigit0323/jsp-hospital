...
ArrayList cases = array.getCasesOne(id);
ArrayList invalid = array.getInvalid(cases.get(1).toString());
    ...
    <td class="border_left border_right border_bottom" height="400" valign="top" align="center"><table border="0" cellspacing="0" cellpadding="0">
      ...
      <form name="form1" method="post" action="" onSubmit="return check()">
        <table width="55%" border="0" cellspacing="1" cellpadding="10" bgcolor="#333333">
          ...
          <tr>
            <td align="right" bgcolor="#C5E8EF">病历号：</td>
            <td bgcolor="#C5E8EF"><%=cases.get(1) %></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right" bgcolor="#C5E8EF">既往史：</td>
            <td bgcolor="#C5E8EF"><%=cases.get(2) %></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#C5E8EF">过敏史：</td>
            <td bgcolor="#C5E8EF"><%=cases.get(3) %></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#C5E8EF">病情症状：</td>
            <td bgcolor="#C5E8EF"><%=cases.get(4) %></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#C5E8EF">病情分析：</td>
            <td bgcolor="#C5E8EF"><%=cases.get(5) %></td>
          </tr>
</table>
    </form></td>
  </tr>
